...
var name = "Exponential Incremental";
var description = "Basic Incremental forever click";
var authors = "Karen";
var version = 1;
...
var init = () => {
    ...
    // c1
    {
        ...
        c1 = theory.createUpgrade(0, currency, new FirstFreeCost(new ExponentialCost(1e8, Math.log2(2))));
    ...
    // c2
    {
        ...
        c2 = theory.createUpgrade(1, currency, new ExponentialCost(2, Math.log2(3)));
    ...
    /////////////////////
    // Permanent Upgrades
    theory.createPublicationUpgrade(0, currency, 1e100);
    theory.createBuyAllUpgrade(1, currency, 1e100000);
...
var getPublicationMultiplier = (tau) => tau.pow(0.722) / BigNumber.THREE;
